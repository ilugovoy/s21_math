...
| 3 | `long double asin(double x)` | вычисляет арксинус | holdosto | LOADING |
| 4 | `long double atan(double x)` | вычисляет арктангенс | holdosto | LOADING |
...
| 11 | `long double log(double x)` | вычисляет натуральный логарифм | shanikat | LOADING |
